...
- **GitHub Username:** IS-PROJECT-2026
...
**What cause did you use?** Concurrent line modification (Same line, different content edits)
...
* **Caption:** Delete/Modify conflict on `about.html` where `conflict-e` deleted the file while `conflict-f` modified the heading.
